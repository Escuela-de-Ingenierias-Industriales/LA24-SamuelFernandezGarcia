###########################################################################
## Makefile generated for component 'MyPiero_ControlOrientacion'. 
## 
## Makefile     : MyPiero_ControlOrientacion.mk
## Generated on : Sun Jan 05 20:26:48 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MyPiero_ControlOrientacion.elf
...
PRODUCT_NAME              = MyPiero_ControlOrientacion
MAKEFILE                  = MyPiero_ControlOrientacion.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MyPiero_ControlOrientacion.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/MyPiero_ControlOrientacion_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=MyPiero_ControlOrientacion -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MyPiero_ControlOrientacion.o MyPiero_ControlOrientacion_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o EncoderPiero_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MyPiero_ControlOrientacion.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/MyPiero_ControlOrientacion.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MyPiero_ControlOrientacion_data.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/MyPiero_ControlOrientacion_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/MyPiero_ControlOrientacion_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
