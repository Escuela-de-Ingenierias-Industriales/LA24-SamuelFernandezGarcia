###########################################################################
## Makefile generated for component 'PruebaSensores'. 
## 
## Makefile     : PruebaSensores.mk
## Generated on : Sun Jan 05 22:18:03 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PruebaSensores.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PruebaSensores.elf
...
DEFINES_STANDARD = -DMODEL=PruebaSensores -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o xcp_ext_mode.o PruebaSensores.o PruebaSensores_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/PruebaSensores_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/PruebaSensores_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PruebaSensores_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PruebaSensores.o : $(START_DIR)/PruebaSensores_ert_rtw/PruebaSensores.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PruebaSensores_data.o : $(START_DIR)/PruebaSensores_ert_rtw/PruebaSensores_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/PruebaSensores_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
