###########################################################################
## Makefile generated for component 'MyPiero_MyPurePursuit'. 
## 
## Makefile     : MyPiero_MyPurePursuit.mk
## Generated on : Tue Jan 07 19:17:29 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MyPiero_MyPurePursuit.elf
...
PRODUCT_NAME              = MyPiero_MyPurePursuit
MAKEFILE                  = MyPiero_MyPurePursuit.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MyPiero_MyPurePursuit.elf
...
DEFINES_STANDARD = -DMODEL=MyPiero_MyPurePursuit -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o MyPiero_MyPurePursuit.o MyPiero_MyPurePursuit_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o EncoderPiero_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MyPiero_MyPurePursuit.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/MyPiero_MyPurePursuit.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MyPiero_MyPurePursuit_data.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/MyPiero_MyPurePursuit_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/MyPiero_MyPurePursuit_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
