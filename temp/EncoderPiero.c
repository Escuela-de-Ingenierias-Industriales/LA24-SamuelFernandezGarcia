 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Jan 05 20:12:57 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                EncoderPiero
...
extern void EncoderPiero_Outputs_wrapper(int32_T *pos,
  const real_T *xD);
extern void EncoderPiero_Update_wrapper(int32_T *pos,
  real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  EncoderPiero_Outputs_wrapper(pos, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  EncoderPiero_Update_wrapper(pos, xD);
}
